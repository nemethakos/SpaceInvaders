// Added new functions: 
//   void Nokia5110_Fill(unsigned char pattern) - pattern fill of screen buffer
//   void NOKIA5110_DrawPixel(unsigned int x, unsigned int y, unsigned int color) - pixel drawing into the screen buffer
//   void Nokia5110_line(int x0, int y0, int x1, int y1, unsigned char color) - line drawing into the screen buffer
//   void Nokia5110_rectangle(int x0, int y0, int x1, int y1, unsigned char color) - rectangle drawing into the screen buffer
// Ákos Németh 2016
...
//********Nokia5110_Fill*****************
// Fills the LCD by writing the specified byte to the entire screen and
// reset the cursor to (0,0) (top left corner of screen).
// inputs: pattern - the byte pattern to write
// outputs: none
void Nokia5110_Fill(unsigned char pattern){
  int i;
  for(i=0; i<(MAX_X*MAX_Y/8); i=i+1){
    lcdwrite(DATA, pattern);
  }
  Nokia5110_SetCursor(0, 0);
}

//********Nokia5110_DrawPixel*****************
// Draws a pixel with the specified color into the screen buffer
...
//                 1 - black
// outputs: none
void NOKIA5110_DrawPixel(unsigned int x, unsigned int y, unsigned int color) {
...
//********Nokia5110_line*****************
// Draws a line from (x0,y0) to (x1,y1) with the specified color into the screen buffer
// inputs: x0 - the x coordinate of the starting point
...
//                 1 - black
// outputs: none
void Nokia5110_line(int x0, int y0, int x1, int y1, unsigned char color) {
  ...
  for(;;){
    NOKIA5110_DrawPixel(x0,y0, color);
...
//********Nokia5110_rectangle*****************
// Draws a rectangle using top left corner (x0,y0) and bottom right corner (x1,y1) with the specified color into the screen buffer
// inputs: x0 - the x coordinate of the top left corner
...
//                 1 - black
// outputs: none
void Nokia5110_rectangle(int x0, int y0, int x1, int y1, unsigned char color) {
Nokia5110_line(x0, y0, x1, y0, color);
Nokia5110_line(x1, y0, x1, y1, color);
Nokia5110_line(x0, y0, x0, y1, color);
Nokia5110_line(x0, y1, x1, y1, color);
...
// outputs: none
void Nokia5110_PrintBMP(unsigned char xpos, unsigned char ypos, const unsigned char *ptr, unsigned char threshold, unsigned char noOverrideMode){
